...
class EntrarLoginWidget extends StatefulWidget {
  const EntrarLoginWidget({super.key});

  @override
  State<EntrarLoginWidget> createState() => _EntrarLoginWidgetState();
}

class _EntrarLoginWidgetState extends State<EntrarLoginWidget>
    with TickerProviderStateMixin {
  late EntrarLoginModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EntrarLoginModel());
