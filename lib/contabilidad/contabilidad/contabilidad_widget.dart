...
class ContabilidadWidget extends StatefulWidget {
  const ContabilidadWidget({super.key});

  @override
  State<ContabilidadWidget> createState() => _ContabilidadWidgetState();
}

class _ContabilidadWidgetState extends State<ContabilidadWidget> {
  late ContabilidadModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContabilidadModel());
