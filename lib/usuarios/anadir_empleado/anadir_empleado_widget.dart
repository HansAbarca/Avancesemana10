...
export 'anadir_empleado_model.dart';

class AnadirEmpleadoWidget extends StatefulWidget {
  const AnadirEmpleadoWidget({
    super.key,
  ...
  @override
  State<AnadirEmpleadoWidget> createState() => _AnadirEmpleadoWidgetState();
}

class _AnadirEmpleadoWidgetState extends State<AnadirEmpleadoWidget>
    with TickerProviderStateMixin {
  late AnadirEmpleadoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AnadirEmpleadoModel());
                                  ...
                                  if (FFAppState().Cargando == false)
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        highlightColor: Colors.transparent,
                                        onTap: () async {
                                          FFAppState().VerificaAnadirEmpleado =
                                              false;
                                          setState(() {});
                                          ...
                                          if ((_model.nombreTextController
                                            ...
                                            if (FFAppState()
                                                    .VerificaAnadirEmpleado ==
                                                true) {
                                              FFAppState().Rol = 'Empleado';
                                              setState(() {});
